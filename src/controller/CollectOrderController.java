//class stores functionality to collect order view
...
public class CollectOrderController {
    ...
    //handle collection of the specific order
    @FXML
    private void handleCollectOrder() {
        ...
        String collectionTime = tfDateTime.getText();
        String validationMessage = model.validateCollectionDate(model.loadUserInput(), selectedOrder.getOrderNumber(), collectionTime);
        ...
        String outputMessage = model.collectOrder(selectedOrder.getOrderNumber(), collectionTime);
